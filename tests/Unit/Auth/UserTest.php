...
class UserTest extends TestCase
{
    ...
    public function testItDeterminesWhetherUserIsActive(array $attributes, bool $expected): void
    {
        $user = new User($attributes);

        self::assertSame($expected, $user->isActiveAt(new \DateTimeImmutable('2026-08-03 12:00:00 UTC')));
    }

    /** @return iterable<string, array{array<string, mixed>, bool}> */
    public static function activityWindows(): iterable
    {
        yield 'inactive without a window' => [['is_active' => false], false];
        yield 'active without a window' => [['is_active' => true], true];
        ...
        yield 'window does not override inactive flag' => [[
            'is_active' => false,
            'active_from' => '2026-08-03 11:00:00',
            'active_until' => '2026-08-03 13:00:00',
        ], false];
